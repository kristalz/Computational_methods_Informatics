...
6. I printed out the estimated values using 1-hash, mean of 10 hash functions, and mean of 100 hash functions for both tests. Using the mean of 10 hash functions to estimate the distinct value were more accurate in the first test (100000), whereas using the mean of 100 hash functions were closer to the actual value in the second test(10000). I wonder what the results would be in chromosome2.

...
Step 4: Using 100 hash functions from the family provided by the question and a single pass through the sequences, estimate the number of distinct 15-mers in the reference genome's chromosome 2. Compare my estimate change for different-sized subsets of these hash functions.

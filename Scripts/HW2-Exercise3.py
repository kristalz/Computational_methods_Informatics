...
# and suggest a strategy for calculating the average that would not require storing all the data in memory (7 points).
...
sys.getsizeof(count_weight)
# 28
sys.getsizeof(total_weight)
# 24
